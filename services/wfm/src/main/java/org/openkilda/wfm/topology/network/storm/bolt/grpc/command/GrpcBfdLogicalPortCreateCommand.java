...
public class GrpcBfdLogicalPortCreateCommand extends GrpcWorkerCommand {
    private final LogicalPortDescriptor portDescriptor;

    public GrpcBfdLogicalPortCreateCommand(String key, SwitchId switchId,
    ...
    public void apply(GrpcWorker handler) throws Exception {
        handler.processBfdPortCreate(getKey(), getSwitchId(), portDescriptor);
    }
}
