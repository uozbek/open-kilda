...
package org.openkilda.wfm.topology.flow.mapper;
...
public class RequestedFlowMapperTest {
    ...
    public static final Integer MAX_LATENCY = 200;
    ...
    private FlowRequest flowRequest = FlowRequest.builder()
            ...
            .detectConnectedDevices(new DetectConnectedDevicesDto(true, true, true, true, true, true))
            .pinned(true)
