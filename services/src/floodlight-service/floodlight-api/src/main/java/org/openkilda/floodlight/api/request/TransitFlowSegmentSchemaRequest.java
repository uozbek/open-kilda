...
public class TransitFlowSegmentSchemaRequest extends TransitFlowSegmentBlankRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public TransitFlowSegmentSchemaRequest(
    ...
    public TransitFlowSegmentSchemaRequest(TransitFlowSegmentBlankRequest other) {
        super(other);
    }
}
