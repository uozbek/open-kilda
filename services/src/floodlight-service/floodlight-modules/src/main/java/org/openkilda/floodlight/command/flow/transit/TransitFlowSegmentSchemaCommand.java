...
@Getter
public class TransitFlowSegmentSchemaCommand extends TransitFlowSegmentInstallCommand {
    @JsonCreator
    public TransitFlowSegmentSchemaCommand(
    ...
    protected CompletableFuture<FlowSegmentReport> makeExecutePlan(SpeakerCommandProcessor commandProcessor) {
        return makeSchemaPlan(ImmutableList.of(makeTransitModMessage()));
    }
}
