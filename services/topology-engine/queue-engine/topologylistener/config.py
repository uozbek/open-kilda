...
KAFKA_FLROUTER_SPEAKER_TOPIC = read_and_format_with_env_name('flrouter.speaker.topic')
KAFKA_FLROUTER_SPEAKER_FLOW_TOPIC = read_and_format_with_env_name('flrouter.speaker.flow.topic')
